...
def start_pannel():
    buttons = [
        ...
        [
            InlineKeyboardButton(text=f"ℹ️ | الاوامر", url=f"https://t.me/P_A_PARIS1/4"),
        ],
    ]
    return (
...
pstart_markup = InlineKeyboardMarkup(
    [
        ...
        [        
            InlineKeyboardButton(text=f"⏏️ | بوت السورس", url=f"https://t.me/P_Jl_bot"),
            InlineKeyboardButton(text=f"🚸 | الــــمطور", url=f"https://t.me/belalelshayal"),
        ],
        [
            InlineKeyboardButton(text=f"👥 | التواصل", url=f"https://t.me/{GROUP}"),
            InlineKeyboardButton(text=f"⏺️ | قناه السورس", url=f"https://t.me/{CHANNEL}"),
        ...
        [        
            InlineKeyboardButton(text=f".َ ‹𝙱𝙴𝙻𝙰𝙻 || بـلال .𓁷", url=f"https://t.me/belalelshayal"),
        ],
    ]
)
        ...
        try:
            ...
            if member.id == BOT_ID:
                ...
                await message.reply_text(
                    f"""**[👋](https://telegra.ph/file/2875489dea129c629dbdc.jpg)
...
async def play(_, message: Message):
    if len(message.command) == 1:
        ...
        await app.send_message(
            message.chat.id,
            text=f"""**
[𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝒑𝒂𝒓𝒊𝒔](https://telegra.ph/file/2875489dea129c629dbdc.jpg)
ꔹ━━ꔹ━ꔹ━━ꔹꔹ━━ꔹ━ꔹ━━ꔹ
〉 ♬ 𝐝𝐞𝐯 𝐦𝐮𝐬𝐢𝐜 : [.َ ‹𝙱𝙴𝙻𝙰𝙻 || بـلال .𓁷](https://t.me/BelalElshayal)
〉 ♬ 𝐩𝐚𝐫𝐢𝐬 𝐦𝐮𝐬𝐢𝐜 : [𝐩𝐚𝐫𝐢𝐬 𝐦𝐮𝐬𝐢𝐜](https://t.me/P_A_PARIS1)
〉 ♬ 𝐓𝐖𝐒𝐎𝐋 : [𝐆𝐑𝐎𝐔𝐏 𝐓𝐖𝐒](https://t.me/paris_tawasol)
 ꔹ━━ꔹ━ꔹ━━ꔹꔹ━━ꔹ━ꔹ━━ꔹ**""",
            parse_mode="markdown",
